...
import { deleteApiKey, listAPIKeys } from "@api/api_key";
...
export default function DeleteApiKeyModal({
	...
	const { refetch } = useQuery("api_keys", () => listAPIKeys());
	...
	const onDelete = async () => {
		try {
			...
			if (res.status === "success") {
				...
				console.error("[onDeleteApiKey] Response", res);
			}
			setIsDeleting(false);
		} catch (err) {
			console.error("[onDeleteApiKey]", err);
										...
										<div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
											...
											<div className="mt-2">
												<p className="text-sm text-gray-500">
													...
													delete this API Key? Any
													application using this key
