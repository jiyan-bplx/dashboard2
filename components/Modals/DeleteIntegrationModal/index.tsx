...
import {
	...
	listIntegrationsForFormId,
} from "@api/integrations/list";
import { DeleteIntegrationByIdResponse } from "@api/integrations/list/responses";
...
export default function DeleteIntegrationModal({
	...
	const { refetch } = useQuery(["integrations", formId], () =>
	...
	const onDelete = async () => {
		try {
			...
			setIsDeleting(true);
			const res = await deleteIntegrationById(
				router.query.integration as string
			);
			if (res.status === "success") {
				...
				console.error("[onDeleteFormIntegration] Response", res);
			}
			setIsDeleting(false);
		} catch (err) {
			console.error("[onDeleteFormIntegration]", err);
			const e = err as AxiosError<DeleteIntegrationByIdResponse>;
